...
func (s *Apis) GetAPI(ctx context.Context, request operations.GetAPIRequest) (*operations.GetAPIResponseBody, error) {
...
func (s *Apis) ListKeys(ctx context.Context, request operations.ListKeysRequest) (*operations.ListKeysResponseBody, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
...
func (s *Apis) DeleteKeys(ctx context.Context, request operations.DeleteKeysRequestBody) (*operations.DeleteKeysResponseBody, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
