...
// V1KeysVerifyKeyResponseIdentity - The associated identity of this key.
...
func (o *V1KeysVerifyKeyResponseIdentity) GetID() string {
	if o == nil {
		return ""
	}
	return o.ID
...
func (o *V1KeysVerifyKeyResponseIdentity) GetExternalID() string {
	if o == nil {
		return ""
	}
	return o.ExternalID
...
func (o *V1KeysVerifyKeyResponseIdentity) GetMeta() map[string]any {
	if o == nil {
...
func (o *V1KeysVerifyKeyResponse) GetIdentity() *V1KeysVerifyKeyResponseIdentity {
	if o == nil {
		return nil
	}
	return o.Identity
