...
const (
	AddPermissionsPermissionsTypeOne AddPermissionsPermissionsType = "1"
	AddPermissionsPermissionsTypeTwo AddPermissionsPermissionsType = "2"
)
...
func CreateAddPermissionsPermissionsOne(one One) AddPermissionsPermissions {
	typ := AddPermissionsPermissionsTypeOne
...
func CreateAddPermissionsPermissionsTwo(two Two) AddPermissionsPermissions {
	typ := AddPermissionsPermissionsTypeTwo
...
func (u *AddPermissionsPermissions) UnmarshalJSON(data []byte) error {
	...
	if err := utils.UnmarshalJSON(data, &one, "", true, true); err == nil {
		u.One = &one
		u.Type = AddPermissionsPermissionsTypeOne
		return nil
	}
	...
	if err := utils.UnmarshalJSON(data, &two, "", true, true); err == nil {
		u.Two = &two
		u.Type = AddPermissionsPermissionsTypeTwo
		return nil
	}
