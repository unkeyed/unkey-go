...
type UpdateIdentityIdentitiesRatelimits struct {
	// The name of this limit.
	Name string `json:"name"`
	// How many requests may pass within a given window before requests are rejected.
	Limit int64 `json:"limit"`
	// The duration for each ratelimit window in milliseconds.
...
func (o *UpdateIdentityIdentitiesRatelimits) GetName() string {
	if o == nil {
		return ""
	}
	return o.Name
...
func (o *UpdateIdentityIdentitiesRatelimits) GetLimit() int64 {
	if o == nil {
		return 0
	}
	return o.Limit
...
func (o *UpdateIdentityIdentitiesRatelimits) GetDuration() int64 {
	if o == nil {
		return 0
	}
	return o.Duration
...
// UpdateIdentityResponseBody - The identity after the update.
type UpdateIdentityResponseBody struct {
	...
	Ratelimits []UpdateIdentityIdentitiesRatelimits `json:"ratelimits"`
}
...
func (o *UpdateIdentityResponseBody) GetExternalID() string {
	if o == nil {
		return ""
	}
	return o.ExternalID
...
func (o *UpdateIdentityResponseBody) GetMeta() map[string]any {
	if o == nil {
...
func (o *UpdateIdentityResponseBody) GetRatelimits() []UpdateIdentityIdentitiesRatelimits {
	if o == nil {
		return []UpdateIdentityIdentitiesRatelimits{}
	}
	return o.Ratelimits
}
...
type UpdateIdentityResponse struct {
	...
	Object *UpdateIdentityResponseBody
}
...
func (o *UpdateIdentityResponse) GetObject() *UpdateIdentityResponseBody {
	if o == nil {
		return nil
	}
	return o.Object
