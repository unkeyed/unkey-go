...
func New(opts ...SDKOption) *Unkey {
	sdk := &Unkey{
		sdkConfiguration: sdkConfiguration{
			...
			SDKVersion:        "0.1.1",
			GenVersion:        "2.326.3",
			UserAgent:         "speakeasy-sdk/go 0.1.1 2.326.3 1.0.0 github.com/unkeyed/unkey-sdk-go",
			Hooks:             hooks.New(),
		},
	}
...
func (s *Unkey) V1ApisCreateAPI(ctx context.Context, request operations.V1ApisCreateAPIRequestBody) (*operations.V1ApisCreateAPIResponseBody, error) {
